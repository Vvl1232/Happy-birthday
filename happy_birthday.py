...
st.markdown(f"<div class='block'><h3 style='text-align: center; color: gold;'>🎂🦚✨🚩 Happy Birthday, {name}! 🦚✨🚩🎂</h2></div>", unsafe_allow_html=True)
st.markdown("")

st.markdown("")
st.markdown("")
st.markdown(f"<div class='block'><h5 style='text-align: center; color: pink;'>🥳 {age} years young today! 🥳</h3></div>", unsafe_allow_html=True)
st.markdown("")
st.markdown("")
